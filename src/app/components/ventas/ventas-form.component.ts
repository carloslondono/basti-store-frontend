...
export class VentasFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.venta.discountPercentage = 0;
  }
  ...
  crear(): void{
    ...
    venta.discountPercentage = this.venta.discountPercentage;
  ...
  calcularTotal(): number{
    ...
    this.venta.purchaseValue = subtotal - ((this.venta.discountPercentage / 100) * subtotal);
